...
@Entity
@Table(name = "Tyadmissions")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class TyAdmission {
	 ...
	 @Id
	    ...
	    private String fyrollno;
	    private String fyentranceRollNo;
	    ...
	    @Transient private MultipartFile syMarkSheet;
	    ...
	    private String syMarkSheetFileName;
	    // Other
