...
<body>
	...
	<div class="container">
		<div class="form-container">
			...
			<form:form method="post" modelAttribute="fyadmission"
				...
				<div class="row">
					<div class="col-md-4 mb-3">
						<form:label path="entranceRank">12th Cet Percentage</form:label>
				...
				<div class="row">
					...
					<div class="col-md-4 mb-3">
						<form:label path="cetScoreCard">12th CET Score Card</form:label>
						<form:input path="cetScoreCard" type="file"
							cssClass="form-control" />
					</div>
				</div>
				...
				<div class="qr-section" style="text-align: center; margin: 20px 0;">
					...
					<div style="margin-top: 10px; font-weight: bold;">Pay the 150
						rupees payment and this payment receipt add form page</div>
