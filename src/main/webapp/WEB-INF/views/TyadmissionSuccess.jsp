...
<body>
	...
	<div class="container">
		<div class="card" id="admissionCard">
			...
			<div class="info-row">
				<div class="info-item">
					<strong>12th Board Roll No:</strong> ${admission.twelfthRollNo}
				</div>
				<div class="info-item">
			...
			<div class="info-row">
				<div class="info-item">
					<strong>FY Rollno:</strong> ${admission.fyrollno}
				</div>
				<div class="info-item">
					<strong>SY Mark/Pointer:</strong> ${admission.entranceExam}
				</div>
				<div class="info-item">
					<strong>TY entrance Seat No:</strong> ${admission.fyentranceRollNo}
				</div>
			</div>

			<div class="info-row">
				<div class="info-item">
					<strong>SY Rollno:</strong> ${admission.diplomaDetails}
				</div>
				<div class="info-item">
					<strong>SY Mark/Pointer:</strong> ${admission.fymark}
				</div>
				<div class="info-item">
					<strong>SY entrance Seat No:</strong> ${admission.entranceRollNo}
				</div>
			</div>
			<div class="info-row">
				<div class="info-item">
			...
			<div class="document-grid">
				...
				<c:if test="${admission.syMarkSheetFileName != null}">
					<div class="document-item">
						<img src="uploads/${admission.syMarkSheetFileName}"
							alt="Sy Score Card">
						<div>Sy Mark Sheet</div>
					</div>
				</c:if>
			</div>
