...
<body>
	...
	<div class="container">
		<div class="form-container">
			...
			<form:form method="post" modelAttribute="admission"
				...
				<div class="row">
					<div class="col-md-4 mb-3">
						<form:label path="diplomaDetails">Fy Rollno</form:label>
						<form:input path="diplomaDetails" cssClass="form-control" />
					</div>
					<div class="col-md-4 mb-3">
						<form:label path="entranceExam">FY Mark/Pointer</form:label>
						<form:input path="entranceExam" cssClass="form-control" />
					</div>
					<div class="col-md-4 mb-3">
						<form:label path="entranceRollNo">Fy entrance Seat No</form:label>
