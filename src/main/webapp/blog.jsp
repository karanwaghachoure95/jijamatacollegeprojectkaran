...
<!-- site metas -->
<title>Jijamata senior Collage</title>
				...
				<div class="col-md-4">
					<div class="blog_box">
						...
						<div class="blog_room">
							...
							<p>The degree shall be titled as Bachelor of Computer Science[B.Sc(CS)] under faculty of science.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="blog_box">
						...
						<div class="blog_room">
							...
							<p>The degree shall be titled as Bachelor of Business Administration (B.B.A.)( Computer Application) under the Faculty of Commerce and Management.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="blog_box">
						...
						<div class="blog_room">
							<span>B.COM </span>
							<p>The degree shall be titled as Bachelor of commerce (B.COM) under faculty of commerce. The program is of three year (six semester)</p>
						</div>
					</div>
				</div>
			</div>
